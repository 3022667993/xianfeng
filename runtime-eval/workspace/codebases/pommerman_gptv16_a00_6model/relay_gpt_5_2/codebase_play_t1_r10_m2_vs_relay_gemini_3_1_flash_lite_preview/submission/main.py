...
# Use runtime-provided side; if missing, treat as unknown (no toggle).
# Fallback to this run's configured side if OPENCLAW_SIDE isn't set by the runner.
side = (os.environ.get("OPENCLAW_SIDE") or "left").strip().lower()
