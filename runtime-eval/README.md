...
- Feedback Package v3 is the current feedback package format.
...
- Feedback Package v3 is a factual package over schedule metadata, scorecards, process feedback, compact trajectory summaries, and prior revision metadata.
